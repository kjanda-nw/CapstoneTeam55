...
Purpose: The purposed of this program was to do some early data exploration for
         the project goals including evaluating potential sources for missing and
         doing an early visualization of the potential target variable and some
         predictors
'
...
#check that there are no additional names left
table(forest_area$Country.Name)
#1990 is the first available data year for target
...
#turn the data from wide to long
...
#repeat the process for population
